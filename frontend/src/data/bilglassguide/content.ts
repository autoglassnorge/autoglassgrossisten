...
export const MANUFACTURERS: Manufacturer[] = [
  { name: 'Pilkington', desc: 'Britisk pioner innen laminert bilglass. Leverer OEM til premium-europeiske merker.', origin: 'Storbritannia', badge: 'OEM', logoPath: '/brands/logos/pilkington.png' },
  { name: 'Saint-Gobain Sekurit', desc: 'Verdens største OEM-leverandør i Europa. Sekurit-brandet er standard på de fleste europeiske biler.', origin: 'Frankrike', badge: 'OEM', logoPath: '/brands/logos/saint-gobain.png' },
  { name: 'AGC', desc: 'Verdens største bilglassprodusent. Japansk teknologileder med fabrikker over hele Europa.', origin: 'Japan / Europa', badge: 'OEM', logoPath: '/brands/logos/agc.svg' },
  { name: 'Guardian', desc: 'Amerikansk produsent med sterk posisjon i Nord-Amerika og voksende europeisk tilstedeværelse.', origin: 'USA', badge: 'OEM', logoPath: '/brands/logos/guardian.png' },
  { name: 'Fuyao', desc: 'Kinesisk produsent som vokser raskt i Europa med konkurransedyktig OEM-kvalitet og pris.', origin: 'Kina / Europa', badge: 'OEM', logoPath: '/brands/logos/fuyao.png' },
  { name: 'Xinyi', desc: 'Kinesisk produsent og raskt voksende aktør i global bilglass med fokus på OEM-kontrakter.', origin: 'Kina', badge: 'OEM', logoPath: '/brands/logos/xinyi.png' },
  { name: 'NordGlass', desc: 'Nordisk produsent med solid posisjon i Skandinavia. OEE-kvalitet til konkurransedyktig pris.', origin: 'Norden', badge: 'OEE', logoPath: '/brands/logos/nordglass.svg' },
  { name: 'Sika', desc: 'Ledende leverandør av strukturelle lim og klebere til bilglassmontering (PUR-basert).', origin: 'Sveits', badge: 'PUR', logoPath: '/brands/logos/sika.png' },
  { name: 'Precision', desc: 'Spesialist på høypresisjonsbilglass og avanserte lamineringsteknologier for premium-segmentet.', origin: 'Europa', badge: 'OEM', logoPath: '/brands/logos/precision.svg' },
];
