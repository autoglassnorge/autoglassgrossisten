    ...
    <>
      ...
      <JsonLd
        data={{
          ...
          mainEntityOfPage: { '@type': 'WebPage', '@id': `https://autoglass.finnbilglass.no${CANONICAL}` },
        }}
      />
      <JsonLd
        data={{
          ...
          itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Kalibrering etter ruteskift', item: `https://autoglass.finnbilglass.no${CANONICAL}` },
          ],
        }}
      />
