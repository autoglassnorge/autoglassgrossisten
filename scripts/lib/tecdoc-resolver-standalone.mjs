 ...
 */
import IDX from "../../api/cf-worker/src/data/tecdoc-index.json" with { type: "json" };
import { normalizeBrand, getBrandAliases } from "./brand-standalone.mjs";

/* ── Types (JSDoc) ────────────────────────────────────────── */

/**
 * @typedef {Object} TecDocCandidate
 * @property {number} ktype
...
/**
 * @typedef {Object} TecDocResult
 * @property {"resolved" | "ambiguous" | "no_match"} status
 * @property {TecDocCandidate[]} candidates
 */
 ...
 * @property {string} normText
 * @property {string[]} tokens
 * @property {Set<string>} tokenSet
 * @property {string[]} chassis
 * @property {Set<string>} chassisSet
 */
